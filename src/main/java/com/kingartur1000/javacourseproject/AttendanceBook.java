/**
 Класс AttendanceBook отвечает за хранение и управление данными о посещаемости студентов.
 Поддерживает добавление и удаление записей, работу с группами, фильтрацию и сортировку,
 подсчёт количества посещений, а также сохранение/загрузку данных в формате Excel.
